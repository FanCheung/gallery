...
export default function Trading() {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row">
      ...
      <Sidebar items={sections} title="Trading" />
      <MobileSidebar items={sections} title="Trading" />
      
      <main className="flex-1 lg:pl-12 py-12 space-y-24">
        {/* Historical Value */}
        <section id="historical-value" className="scroll-mt-24 space-y-8">
          <div className="border-b pb-4">
            <h1 className="text-4xl font-bold uppercase tracking-tighter">Historical Value</h1>
          </div>
          <div className="space-y-6 text-muted-foreground font-light leading-relaxed max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
              <div className="border p-6 space-y-2">
                <h3 className="text-sm font-bold uppercase">Provenance Verification</h3>
                <p className="text-xs">Rigorous tracing of ownership history to ensure authenticity and legal title.</p>
              </div>
              <div className="border p-6 space-y-2">
                <h3 className="text-sm font-bold uppercase">Market Benchmarking</h3>
        ...
        <section id="club" className="scroll-mt-24 space-y-8">
          ...
          <div className="bg-primary text-primary-foreground p-12 space-y-6">
            <h3 className="text-2xl font-bold uppercase tracking-tight">An Exclusive Circle of Collectors</h3>
